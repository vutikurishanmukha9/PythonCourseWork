...
a = 20
b = 10
print("Addition(+):",a+b) #30 //Addition
print("Subtraction(-):",a-b) #10 //Subtraction
print("Multiplication(*):",a*b) #200 //Multiplication
print("Floor Division(//):",a//b) #2 //Floor divison to get the output in Integer
