...
The Correct Answer is C: "A high-level, interpreted programming language"

Your Score: 0/1
--------------------------------------------------
Question 2: What is the difference between lists and tuples?
A: Lists are immutable, tuples are mutable
B: Lists are unordered, tuples are ordered
C: Lists are mutable, tuples are immutable
D: Lists and tuples are the same
...
Your Score: 1/2
--------------------------------------------------
Question 3: What is the Global Interpreter Lock (GIL)?
A: A lock for securing global variables
B: A mutex that allows only one thread to execute at a time in Python
C: A way to prevent memory leaks
D: A method to lock files during reading

The Correct Answer is B: "A mutex that allows only one thread to execute at a time in Python"
...
The Correct Answer is B: "Functions that modify the behavior of other functions"

Your Score: 1/4
--------------------------------------------------
Question 5: What is the difference between shallow copy and deep copy?
A: No difference at all
B: Deep copy is faster than shallow copy
C: Shallow copy copies everything recursively
D: Deep copy copies all nested objects, shallow copy only top-level

The Correct Answer is D: "Deep copy copies all nested objects, shallow copy only top-level"

Your Score: 1/5
--------------------------------------------------
Question 6: What are *args and **kwargs?
A: Used to define class attributes
B: Used to pass variable number of arguments to a function
C: Used in list comprehension
D: Used to create decorators

The Correct Answer is B: "Used to pass variable number of arguments to a function"

Your Score: 1/6
--------------------------------------------------
Question 7: What is the with statement/context manager?
A: A loop to iterate through a block
B: Used to define global variables
C: A way to automatically manage resources like files
D: Used only in class definitions

The Correct Answer is C: "A way to automatically manage resources like files"

Your Score: 1/7
--------------------------------------------------
Question 8: What are generators?
A: Functions that create random numbers
B: Loops that never end
C: Functions that yield items one at a time using yield
D: Built-in data types

The Correct Answer is C: "Functions that yield items one at a time using yield"
...
The Correct Answer is A: "A concise way to create lists"

Your Score: 1/9
--------------------------------------------------
Question 10: What is the difference between == and is operators?
A: No difference
B: == compares values, is compares identity
C: is is used in loops only
D: == checks type, is checks value

The Correct Answer is B: "== compares values, is compares identity"

Your Score: 1/10
--------------------------------------------------
Question 11: What are lambda functions?
A: Anonymous one-liner functions
B: Loops inside functions
C: Named recursive functions
D: Built-in sorting tools

Correct! Anonymous one-liner functions.

Your Score: 2/11
--------------------------------------------------
Question 12: What is inheritance in Python?
A: Copying variables between scripts
B: One class acquiring properties of another class
C: Encrypting a function
D: A way to optimize memory

The Correct Answer is B: "One class acquiring properties of another class"

Your Score: 2/12
--------------------------------------------------
Question 13: How does Python handle exceptions?
A: Using if statements
B: Using exit() function
C: Using try, except, finally blocks
D: Automatically retries the code

The Correct Answer is C: "Using try, except, finally blocks"

Your Score: 2/13
--------------------------------------------------
Question 14: What is the __init__ method?
A: A variable
B: Constructor method in a class
C: Built-in list function
D: Loop initializer

The Correct Answer is B: "Constructor method in a class"

Your Score: 2/14
--------------------------------------------------
Question 15: What is a KeyError and how to handle it?
A: A syntax error
B: Error raised when a dictionary key is not found; handle with try-except
C: Issue with strings
D: Related to index out of range

The Correct Answer is B: "Error raised when a dictionary key is not found; handle with try-except"

Your Score: 2/15
--------------------------------------------------
Question 16: How does Python's memory management work?
A: Automatic using reference counting and garbage collection
B: Manual like in C
C: Memory is never freed
D: Through a memory stack only

The Correct Answer is A: "Automatic using reference counting and garbage collection"

Your Score: 2/16
--------------------------------------------------
Question 17: What is Method Resolution Order (MRO)?
A: A way to sort methods alphabetically
B: The order in which Python looks for methods in a hierarchy
C: The order methods are written
D: The order functions are compiled

The Correct Answer is B: "The order in which Python looks for methods in a hierarchy"
...
Correct! Python style guide for code formatting.

Your Score: 3/18
--------------------------------------------------
Question 19: What are sets and dictionaries?
A: Both are lists
B: Set stores unique items; dictionary stores key-value pairs
C: Both store only numbers
D: Dictionary is an ordered set

The Correct Answer is B: "Set stores unique items; dictionary stores key-value pairs"

Your Score: 3/19
--------------------------------------------------
Question 20: What is the difference between Python 2 and Python 3?
A: Python 3 is faster
B: Python 2 has more features
C: Python 3 uses print() as a function; Python 2 uses it as a statement
D: No difference

The Correct Answer is C: "Python 3 uses print() as a function; Python 2 uses it as a statement"
...
The Correct Answer is A: "Extracting a portion of a sequence"

Your Score: 3/21
--------------------------------------------------
Question 22: What is enumerate() used for?
A: For adding items to a list
B: For reversing strings
C: Iterates with index and value in a loop
D: Converts string to number

The Correct Answer is C: "Iterates with index and value in a loop"

Your Score: 3/22
--------------------------------------------------
Question 23: What is pickling and unpickling?
A: Serializing and deserializing Python objects
B: Encrypting passwords
C: Backing up data
D: Compressing files

Correct! Serializing and deserializing Python objects.

Your Score: 4/23
--------------------------------------------------
Question 24: What are modules and packages?
A: Same as loops
B: Used for GUI
C: Modules are .py files; packages are collections of modules
D: Python built-in data types

The Correct Answer is C: "Modules are .py files; packages are collections of modules"

Your Score: 4/24
--------------------------------------------------
Question 25: How do you reverse a string in Python?
A: Using sort()
B: Using .reverse()
C: Using slicing: string[::-1]
D: Using reversed() function directly on string

The Correct Answer is C: "Using slicing: string[::-1]"

Your Score: 4/25
--------------------------------------------------

==================================================
🎉 Quiz Completed! Your Final Score: 4/25
📘 Don't worry, review the basics and try again.
==================================================
'''